    ...
    class Program
    {
        static void Main()
        {
            ...
            RomanNumber c = new RomanNumber(2709);
             ...
             Console.WriteLine("9 + 150 = 159 | CLIX | " + (a + b).ToString());
             Console.WriteLine("2709 - 150 = 2559 | MMDLIX | " + (c - b).ToString());
             Console.WriteLine("9 * 150 = 1350 | MCCCL | " + (a * b).ToString());
             Console.WriteLine("2709 / 9 = 301 | CCCI | " + (c / a).ToString());
